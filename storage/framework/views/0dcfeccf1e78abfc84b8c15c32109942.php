                ...
                <tr>
                    ...
                    <td>
                        <form action="<?php echo e(route('products.destroy', $product->id)); ?>" method="post">
                            ...
                            <a href="<?php echo e(route('search.show', $product->id)); ?>" class="btn btn-warning btn-sm" target="_blank"><i class="bi bi-eye"></i> Show</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel-10-roles\resources\views/search.blade.php ENDPATH**/ ?>